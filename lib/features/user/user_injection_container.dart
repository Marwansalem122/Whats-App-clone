...
import 'package:whatsapp_clone/features/user/domain/usecases/credential/verify_phone_number_usecsae.dart';
...
Future<void> userInjectionContainer() async {
  //* It registers Cubits, Use Cases, Repositories, and Data Sources.
  // * CUBITS INJECTION
  // *  means a new instance is created every time it is requested.
  ...
  // * USE CASES INJECTION
  // * They are registered as lazy singletons, so they will only be created when needed.
